...
/*
Версия где значание ключа по умолчанию вынесено за таблицу
и записывается в отбельную переменную для избежания конфликтов.

В прошлой версии значение было в таблице,
но это место могло занять только значение с ключем по умолчанию.

Если вам не сложно, можете хоть намекнуть как правильно выполнить эту задачу?
 */
